export default function Carousel(
  ...
  this.crslElements = this.crslList.querySelectorAll(".carousel__element");
  this.crslElemFirst = this.crslList.querySelector(".carousel__element");
  this.leftArrow = this.crslRoot.querySelector("div.carousel__arrow-left");
  this.rightArrow = this.crslRoot.querySelector("div.carousel__arrow-right");
  this.indicatorDots = this.crslRoot.querySelector("div.carousel__dots");
  this.countText = this.crslRoot.querySelector(".carousel__count");
...
Carousel.prototype.elemPrev = function (num) {
  ...
  if (!this.options.loop) {
    ...
    if (this.currentElement == 0) {
      ...
      this.leftArrow.style.backgroundColor = "#D6D6D6";
      this.touchPrev = false;
    } else {
      this.leftArrow.style.backgroundColor = "#313131";
    }
    this.rightArrow.style.pointerEvents = "auto";
    this.rightArrow.style.backgroundColor = "#313131";
    this.touchNext = true;
  } else {
...
Carousel.prototype.elemNext = function (num) {
  ...
  if (!this.options.loop) {
    ...
    if (this.currentElement == this.dotsVisible - 1) {
      ...
      this.rightArrow.style.backgroundColor = "#D6D6D6";
      this.touchNext = false;
    } else {this.rightArrow.style.backgroundColor = "#313131";}
...
Carousel.initialize = function (that) {
  ...
  if (!that.options.loop) {
    ...
    that.dotsVisible = that.elemCount - that.options.elemVisible + 1;// отключить левую стрелку
    that.leftArrow.style.pointerEvents = "none";
    that.leftArrow.style.backgroundColor = "#D6D6D6";
    that.rightArrow.style.backgroundColor = "#313131";
  ...
  if (that.options.dots) {
    ...
    that.indicatorDotsAll = that.crslRoot.querySelectorAll("span.dot");
